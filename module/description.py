...
from module.desc_config import desc_key_map, model_config, sense_config,model_config_old
...
class Description(object):
    ...
    def init(self, key_list=list(desc_key_map.keys())):
        ...
        #     return -1011004, '描写对象初始化错误:嗅觉模型初始化错误'
        ...
        try:
            ...
            return -1011005, '描写对象初始化错误:描写动作模型初始化错误'
    ...
    def get_all_descriptions(self, sent_list, essay_type='common'):
        ...
        try:
            ...
            info = {}
            info['action'] =  {'pred_result': [], 'match_result': []}
            ...
            description_info['description'] = "描写模块批处理:动作模块处理错误!"
